...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24" style={{backgroundImage: `url(${'/sky.jpg'})`, backgroundSize:'cover'}}>
      ...
      <div ref={rocketRef} id='rocket-container' className={`${isInvincible && 'wiggle'}`}  style={{
        ...
        <BalloonComponent degrees={degrees} />
      </div>
